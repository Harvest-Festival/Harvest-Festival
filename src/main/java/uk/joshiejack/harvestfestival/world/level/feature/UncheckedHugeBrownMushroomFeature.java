...
public class UncheckedHugeBrownMushroomFeature extends HugeBrownMushroomFeature {
    public UncheckedHugeBrownMushroomFeature(Codec<HugeMushroomFeatureConfiguration> codec) {
        super(codec);
    }
