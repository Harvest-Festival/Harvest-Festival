...
@OnlyIn(Dist.CLIENT)
public class FrostBatModel extends HierarchicalModel<FrostBat> {
    ...
    public FrostBatModel(ModelPart part) {
    ...
    @Override
    public void setupAnim(FrostBat bat, float p_102201_, float p_102202_, float p_102203_, float p_102204_, float p_102205_) {
