...
public abstract class PenguinScreen extends Screen {
    ...
    protected PenguinScreen(Component pTitle, ResourceLocation texture) {
        this(pTitle, texture, 166, 201);
    }

    protected PenguinScreen(Component pTitle, ResourceLocation texture, int imageWidth, int imageHeight) {
        super(pTitle);
