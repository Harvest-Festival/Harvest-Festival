...
public class RemoveFertilizerPacket implements PenguinPacket {
    public static final ResourceLocation ID = PenguinLib.prefix("remove_fertilizer");
    ...
    public RemoveFertilizerPacket(BlockPos pos, Fertilizer fertilizer) {
        this.pos = pos;
        this.fertilizer = fertilizer;
    }

    public RemoveFertilizerPacket(FriendlyByteBuf buf) {
    ...
    public void handleClient() {
        FertilizerLevelOverlay.removeBlock(fertilizer, pos);
    }
}